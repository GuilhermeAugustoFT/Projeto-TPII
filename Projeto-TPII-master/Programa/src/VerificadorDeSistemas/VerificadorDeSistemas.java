...
public class VerificadorDeSistemas implements Cloneable
{
     ...
     */
    public boolean haPossibilidadeDeResolucao()
    {
     ...
     * @return um String contendo a matriz de equações e a quantidade de equações.
     */
     ...
     * @return a cópia deste VerificadorDeSistemas como Object.
     */
    public Object clone()
    {
