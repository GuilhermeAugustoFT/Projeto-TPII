...
import java.io.*; //"*" == TUDO, como em SQL.
...
public class Teclado
{
    ...
    public static String getUmString()
    {
        ...
        catch(IOException erro) //Teclados não dão erro
    ...
    public static char getUmChar() throws Exception
    {
        ...
        try
        {
            ...
            if(str.length() != 1)
             ...
             ret = str.charAt(0); //Primeiro caracter, e o único!
        }
        catch(IOException erro)
        {} // sei que nao vai dar erro
    ...
    public static boolean getUmBoolean() throws Exception
    {
        ...
        try
        {
            ...
            //str = str.toLowerCase(); //Transforma tudo em minúsculo!
